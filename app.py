...
# ★ 一覧表示用のコードを、一番最初に正常に動いていた状態に完全に復元しました
...
def fetch_spot_1hour_data(url):
    try:
        ...
        if not weekly_data or len(weekly_data) < 8:
            weekly_data = [
                {"date": "取得中", "img_url": "https://gvs.weathernews.jp/onebox/img/wxicon/200.png", "temp_max": "-", "temp_min": "-", "rain_prob": "-"} for _ in range(8)
            ]
