...
SPOT_WEATHER_DATA = {
    ...
    # --- 栃木県 ---
    "キングフィッシャー": {"url": "https://weathernews.jp/onebox/36.907054/140.078650/", "tenki_url": "https://tenki.jp/forecast/3/12/4120/9210/1hour.html", "hp_url": "https://kingfisher-tochigi.com/", "x_url": "", "fb_url": "", "insta_url": "", "blog_url": "", "yt_url": "", "search_name": "キングフィッシャー 大田原", "tel": "0287-23-1253", "aliases": ["キングフィッシャー", "キング", "きんぐふぃっしゃー"]},
    ...
    if spot_name in MEMORY_CACHE:
        ...
        if now - updated_time <= timedelta(hours=2):
            if isinstance(data, dict):
                ...
                if data.get("_version") != "settings_shortcut_v94": return None
                ...
                try:
                    ...
                    if now - updated_time <= timedelta(hours=2):
                        ...
                        if isinstance(weather_data, dict):
                            ...
                            if weather_data.get("_version") != "settings_shortcut_v94": return None
                            if not weekly or len(weekly) < 4 or weekly[0].get("temp_max") == "-": return None
...
def save_cached_weather(spot_name, weather_data):
    now = datetime.now(timezone.utc)
    weather_data["_version"] = "settings_shortcut_v94"
